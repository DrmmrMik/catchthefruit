...
export class RoundSummaryScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    // Celebration Card Panel (400x520px)
    const cardBg = this.add.graphics();
    cardBg.fillStyle(0xffffff, 1);
    cardBg.lineStyle(3, this.summaryData.isMastered ? 0x10b981 : 0x0284c7, 1);
    cardBg.fillRoundedRect(width / 2 - 190, 80, 380, 560, 24);
    cardBg.strokeRoundedRect(width / 2 - 190, 80, 380, 560, 24);
    ...
    this.add.text(width / 2, 170, levelConfig?.name ?? `Level ${this.summaryData.levelNumber}`, {
      fontFamily: 'Lexend, sans-serif',
      fontSize: '15px',
      color: '#334155',
      fontStyle: 'bold'
    ...
    statBg.fillRoundedRect(width / 2 - 150, 290, 300, 100, 16);
    statBg.strokeRoundedRect(width / 2 - 150, 290, 300, 100, 16);

    this.add.text(width / 2 - 75, 325, `Score\n${this.summaryData.score}`, {
      fontFamily: 'Lexend, sans-serif',
      fontSize: '16px',
      color: '#0f172a',
      fontStyle: 'bold',
    ...
    this.add.text(width / 2 + 75, 325, `Accuracy\n${this.summaryData.accuracy}%`, {
      fontFamily: 'Lexend, sans-serif',
      fontSize: '16px',
    ...
    this.add.text(width / 2, 420, feedbackMsg, {
      fontFamily: 'Lexend, sans-serif',
      fontSize: '13px',
      color: '#475569',
      align: 'center',
